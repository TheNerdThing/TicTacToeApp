...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean checkVictory(){
        ...
        for(int i = 0; i < board.length; i++){
            if((board[i][1].getText() == board[i][0].getText() ) && ( board[i][0].getText() == board[i][2].getText())  && board[i][0].getText() != ""){
                return  true;
            }
            if((board[1][i].getText() == board[0][i].getText() ) && board[0][i].getText() == board[2][i].getText() && board[2][i].getText() != ""){
                return  true;
            }
        }
        // check diagonals
        if (board[1][1].getText().equals(board[0][0].getText() )   &&  board[1][1].getText().equals(board[2][2].getText() )  && board[0][0].getText() != ""){
            return true;
        }
